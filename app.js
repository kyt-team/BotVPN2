...
const TOPIC_ID = vars.TOPIC_ID;
const bot = new Telegraf(BOT_TOKEN);
const adminIds = ADMIN;
logger.info('Bot initialized');

const db = new sqlite3.Database('./sellvpn2.db', (err) => {
  if (err) {
...
bot.command(['start', 'menu'], async (ctx) => {
  // Batasi hanya di private chat
  if (ctx.chat.type !== 'private') {
    return ctx.reply('❌ Bot hanya bisa digunakan di private chat!');
  }
      ...
      if (depositAge > 5 * 60 * 1000) {
        try {
          ...
          await bot.telegram.sendMessage(deposit.userId, 
            '❌ *Pembayaran Expired*\n\n' +
            'Waktu pembayaran telah habis. Silakan klik Top Up lagi untuk mendapatkan QR baru atau hubungi admin .',
            { parse_mode: 'Markdown' }
          );
    } catch (error) {
...
const data = qs.stringify({
  'app_reg_id': 'fU5no0OrQK2qWeoKT_pAlL:APA91bF3Gn0Q2ksv001Vs-FSH9-RNJDFBziX7_fxpVVrlT8hHB6nATZzLs617vbCq48ZypkPePzjQ2EZiku3NHE7uXjqgQj2VDbAoLFqnAUbfzKgrY8OAHY',
  'phone_uuid': 'fU5no0OrQK2qWeoKT_pAlL',
  'phone_model': 'Infinix X6855',
  'requests[qris_history][keterangan]': '',
  'requests[qris_history][jumlah]': '',
  'request_time': '1757646120438',
  'phone_android_version': '15',
  'app_version_code': '250911',
  'auth_username': 'adisaputra94',
  'requests[qris_history][page]': '1',
  'auth_token': '473713:W3KDPx5Z8nuFsYRvp4oqLOQg0bzGl9md',
...
const resultcek = await axios.post('https://app.orderkuota.com/api/v2/qris/mutasi/473713', data, {
  headers: {
    'signature': '61d9f767b2b933cde172fd195a218644967449bf3f694a201d095d4b254e813b37c3415ecd199cd22a1a073a28c3b25e5fd54cbe8bab991179e3214eb2902036',
    'timestamp': '1757646120438',
...
🕒 Waktu: ${new Date().toLocaleString('id-ID', { timeZone: 'Asia/Jakarta' })}
  ...
  { 
    parse_mode: 'HTML',
    message_thread_id: TOPIC_ID   // <<=== tambahkan ini
  }
);
